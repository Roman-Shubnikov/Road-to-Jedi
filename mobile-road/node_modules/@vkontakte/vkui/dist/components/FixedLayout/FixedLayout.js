...
var FixedLayout = /*#__PURE__*/function (_React$Component) {
  ...
  function FixedLayout() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onViewTransitionStart", function (e) {
      ...
      var toPanelHasScroll = _this.props.panel === e.detail.to && panelScroll > 0; // Для панелей, с которых уходим всегда выставляется скролл
      // Для панелей на которые приходим надо смотреть, есть ли браузерный скролл

      if (fromPanelHasScroll || toPanelHasScroll && _this.canTargetPanelScroll) {
        _this.setState({
          position: 'absolute',
  ...
  _createClass(FixedLayout, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["className", "children", "style", "vertical", "getRootRef", "platform", "filled", "splitCol", "panel"]);
...
export default withContext(withPlatform(withPanelContext(FixedLayout)), SplitColContext, 'splitCol');
