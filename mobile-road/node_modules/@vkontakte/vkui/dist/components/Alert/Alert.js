...
var Alert = /*#__PURE__*/function (_Component) {
      ...
      switch (platform) {
        case ANDROID:
          return /*#__PURE__*/React.createElement(Button, {
            className: classNames('Alert__button', "Alert__button--".concat(action.mode)),
            mode: "tertiary",
            size: "m",
        ...
        default:
          return /*#__PURE__*/React.createElement(Tappable, {
            Component: "button",
            className: classNames('Alert__action', "Alert__action--".concat(action.mode)),
            onClick: _this.onItemClick(action),
            key: "alert-action-".concat(i)
          }, action.title);
      }
  ...
  _createClass(Alert, [{
    ...
    value: function render() {
      ...
      }), canShowCloseButton && /*#__PURE__*/React.createElement(ModalDismissButton, {
        onClick: this.onClose
      }), /*#__PURE__*/React.createElement("div", {
        className: "Alert__content"
      }, hasReactNode(header) && this.renderHeader(header), hasReactNode(text) && this.renderText(text), children), /*#__PURE__*/React.createElement("footer", {
