  ...
  _createClass(BaseGallery, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props3, ["children", "slideWidth", "slideIndex", "isDraggable", "onDragStart", "onDragEnd", "onChange", "onEnd", "align", "bullets", "className", "platform", "hasMouse", "showArrows"]);
      ...
      })), showArrows && hasMouse && this.canSlideLeft && /*#__PURE__*/React.createElement(HorizontalScrollArrow, {
        direction: "left",
        onClick: this.slideLeft
      }), showArrows && hasMouse && this.canSlideRight && /*#__PURE__*/React.createElement(HorizontalScrollArrow, {
        direction: "right",
...
var BaseGalleryAdaptive = withAdaptivity(BaseGallery, {
  hasMouse: true
});
var Gallery = withFrame(function (_ref3) {
  ...
  useEffect(function () {
    ...
    var id = props.window.setTimeout(function () {
      return handleChange((slideIndex + 1) % childCount);
    }, timeout);
    return function () {
      return props.window.clearTimeout(id);
    };
  }, [timeout, slideIndex, childCount]); // prevent overflow

  useEffect(function () {
    return handleChange(Math.min(slideIndex, childCount - 1));
  }, [childCount]);
  return /*#__PURE__*/React.createElement(BaseGalleryAdaptive, _extends({
