...
_defineProperty(ModalRootTouchComponent, "contextTypes", {
  window: PropTypes.any,
  document: PropTypes.any
});

export var ModalRootTouch = withContext(withPlatform(ModalRootTouchComponent), ConfigProviderContext, 'configProvider');
