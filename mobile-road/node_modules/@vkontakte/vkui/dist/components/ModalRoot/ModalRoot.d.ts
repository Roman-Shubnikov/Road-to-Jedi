...
declare class ModalRootTouchComponent extends Component<ModalRootProps, ModalRootState> {
     ...
     */
    animateTranslate(modalState: ModalsStateEntry, percent: number): void;
...
export declare const ModalRootTouch: typeof ModalRootTouchComponent;
export {};
