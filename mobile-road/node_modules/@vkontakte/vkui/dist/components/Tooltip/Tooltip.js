  ...
  _createClass(TooltipPortal, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement("div", {
        className: classNames(baseClassName, "Tooltip--x-".concat(alignX), "Tooltip--y-".concat(alignY), "Tooltip--".concat(mode), {
...
var Tooltip = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var child = /*#__PURE__*/React.cloneElement(children, _defineProperty({}, isDOMTypeElement(children) ? 'ref' : 'getRootRef', this.getRef));
