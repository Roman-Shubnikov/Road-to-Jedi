...
var Tappable = /*#__PURE__*/function (_Component) {
  ...
  function Tappable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "containerHasTransparentBackground", function () {
      if (!_this.container) {
        return true;
      }
  ...
  _createClass(Tappable, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["children", "className", "Component", "activeEffectDelay", "stopPropagation", "getRootRef", "platform", "sizeX", "hasMouse", "hasHover", "hasActive"]);

      var hoverClassModificator = this.containerHasTransparentBackground() ? 'shadowHovered' : 'opacityHovered';
      var classes = classNames(getClassName('Tappable', platform), className, "Tappable--sizeX-".concat(sizeX), _defineProperty({
      ...
      return /*#__PURE__*/React.createElement(TappableContext.Consumer, null, function (_ref4) {
        ...
        return /*#__PURE__*/React.createElement(TouchRootContext.Consumer, null, function (insideTouchRoot) {
          ...
          return /*#__PURE__*/React.createElement(RootComponent, _extends({
            ...
            className: classes
          }, props), /*#__PURE__*/React.createElement(TappableContext.Provider, {
            value: {
              insideTappable: true,
              onEnter: function onEnter() {
          ...
          }, children), platform === ANDROID && !hasMouse && /*#__PURE__*/React.createElement("span", {
