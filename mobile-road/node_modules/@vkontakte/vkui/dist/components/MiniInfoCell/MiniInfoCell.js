...
export var MiniInfoCell = function MiniInfoCell(props) {
  ...
  var before = props.before,
      ...
      restProps = _objectWithoutProperties(props, ["before", "after", "mode", "textWrap", "textLevel", "children", "className"]);

  var Component = restProps.onClick ? Tappable : 'div';
  return /*#__PURE__*/React.createElement(Component, _extends({}, restProps, {
    className: classNames(getClassName('MiniInfoCell', platform), (_classNames = {}, _defineProperty(_classNames, "MiniInfoCell--md-".concat(mode), mode !== 'base'), _defineProperty(_classNames, "MiniInfoCell--wr-".concat(textWrap), textWrap !== 'nowrap'), _classNames), "MiniInfoCell--lvl-".concat(textLevel), className)
