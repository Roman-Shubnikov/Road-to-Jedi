...
var Snackbar = /*#__PURE__*/function (_PureComponent) {
  ...
  function Snackbar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onTouchMoveX", function (event) {
      ...
      _this.shiftXPercent = shiftX / _this.bodyElRef.current.offsetWidth * 100;
      _this.shiftXCurrent = rubber(_this.shiftXPercent, 72, 1.2, _this.props.platform === ANDROID || _this.props.platform === VKCOM);
    ...
    _defineProperty(_assertThisInitialized(_this), "onTouchEnd", function () {
      ...
      if (_this.state.touched) {
        var shiftXCurrent = _this.shiftXCurrent;
        var expectTranslateY = shiftXCurrent / (Date.now() - _this.touchStartTime.getTime()) * 240 * 0.6;
        shiftXCurrent = shiftXCurrent + expectTranslateY;

        if (_this.isDesktop && shiftXCurrent <= -50) {
          _this.clearCloseTimeout();
        ...
        } else if (!_this.isDesktop && shiftXCurrent >= 50) {
          _this.clearCloseTimeout();
  ...
  _createClass(Snackbar, [{
    ...
    value: function render() {
      ...
      var resolvedLayout = after || this.isDesktop ? 'vertical' : layout;
      return /*#__PURE__*/React.createElement(AppRootPortal, null, /*#__PURE__*/React.createElement(FixedLayout, {
        vertical: "bottom",
