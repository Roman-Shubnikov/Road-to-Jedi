...
const App = () => {
    ...
    const { activeStory, historyPanels, snackbar, activePanel, popout } =
    ...
    const setBanObject = useCallback(
        (payload) => dispatch(accountActions.setBanObject(payload)),
        [dispatch]
    );
    const setScheme = useCallback(
        (payload) => dispatch(accountActions.setScheme(payload)),
        [dispatch]
    );
            ...
            if (hash.promo !== undefined && activePanel !== 'promocodes') {
                ...
                if (activePanel !== 'other_profile' && !ignoreOtherProfile) {
                    ...
                    goOtherProfileCreator(
                        goPanel,
                        viewsStructure.Questions.navName,
                        showErrorAlert,
                        OtherProfileData,
                        dispatch,
                        hash.agent_id
                ...
                setActiveScene(
                    viewsStructure.Questions.navName,
                    viewsStructure.Questions.panels.homepanel
                );
            }
        }
    }, [
                ...
                <AppRoot>
                    ...
                    >
                                            ...
                                            <Group>
                                                <RichCell
                                                    ...
                                                    className={classNames({
                                                        'vkuiTappable--active-background':
                                                            activeStory ===
                                                            'Profile',
                                                    })}
                                                    onClick={() => {
                        ...
                        >
                            <SkeletonTheme
                                color={
                                    ['bright_light', 'vkcom_light'].indexOf(
                                        scheme
                                    ) !== -1
                                        ? undefined
                                        : '#232323'
